...
#define LL_VIEWER_CHANNEL Vulkanstorm-Dev
#define LL_VIEWER_VERSION_MAJOR 0
#define LL_VIEWER_VERSION_MINOR 1
#define LL_VIEWER_VERSION_PATCH 2608
#define LL_VIEWER_VERSION_YEAR 26
#define LL_VIEWER_VERSION_MONTH_STRING "08"
#define LL_VIEWER_VERSION_BUILD 81460
const std::string LL_VIEWER_VERSION_GITHASH {};
const std::string LL_VIEWER_VERSION_LL{"26.2.0"};
#define LLBUILD_CONFIG "RelWithDebInfo"
