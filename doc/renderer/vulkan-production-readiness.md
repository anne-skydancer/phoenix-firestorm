...
| P0e4 recursive/offscreen views | In progress; authenticated packet accepted and bounded peer replay passes on the current working tree | The P0e4a manifest preserves the authenticated 11-pass packet. Packet-driven Vulkan validation and OpenGL peers replay all six canonical cube faces plus impostor, dynamic texture, preview, pre-water alpha, and activated media surface with full 704-pixel coverage and matching normalized image SHA-256 `a27e7aa758451eddc5b59d720251f242b90c37cd026be8851c2cf3dcb571b65d`. Commit and manifest this replay, then replace semantic clear imagery with real scene-content evidence and export the reflection/exclusion resources required by P0e2. |
