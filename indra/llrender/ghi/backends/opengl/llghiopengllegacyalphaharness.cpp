...
#include "tests/ghi/llghilegacyalphafixture.h"
#include <windows.h>
#include <GL/gl.h>
#include <algorithm>
#include <iostream>
#ifndef LL_GHI_R6_LEGACY_SHADER_PACKAGE
#error LL_GHI_R6_LEGACY_SHADER_PACKAGE must name the R6 legacy-alpha package
#endif
namespace
{
LRESULT CALLBACK windowProcedure(HWND window, UINT message, WPARAM wparam, LPARAM lparam)
{ return DefWindowProc(window, message, wparam, lparam); }
void report(const LL::GHI::Test::LegacyAlphaFixtureResult& result, const char* profile)
{
...
int main()
{
    ...
    const wchar_t* className = L"VulkanstormR6LegacyAlphaOpenGLHarness";
    ...
    HWND window = CreateWindowExW(0, className, L"R6 OpenGL legacy alpha",
    ...
    auto status = LL::GHI::loadShaderPackage(LL_GHI_R6_LEGACY_SHADER_PACKAGE, package);
    int exitCode = 0;
