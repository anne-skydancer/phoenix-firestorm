/**
 * @file llghivulkanworldharness.cpp
 * @brief Native Vulkan execution harness for the R5c-e world fixture.
 *
...
int main(int argc, char** argv)
{
    ...
    const auto result = LL::GHI::Test::runWorldFixture(*creation.device, package);
    if (!result.passed)
    {
