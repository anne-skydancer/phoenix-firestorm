...
void main()
{
    vec4 base = texture(baseColorMap, texCoord) * materialData.baseColorFactor * vertexColor;
    ...
    vec3 emissive = texture(emissiveMap, texCoord).rgb * materialData.emissiveMetallic.rgb;
